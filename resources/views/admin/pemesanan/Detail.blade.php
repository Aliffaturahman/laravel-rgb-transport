...
@section('title', 'Detail Pemesanan - Admin RGB Transport')

@section('content')
<div class="container-fluid py-4">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Detail Pemesanan</h1>
        <a href="{{ route('admin.pemesanan.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="mt-4 text-center">
                <a href="{{ route('admin.pemesanan.invoice', $pemesanan->id) }}" class="btn btn-primary" target="_blank">
